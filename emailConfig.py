...
dBody = "Dear {0},\n\nThank you for taking the time to consider Harare Institute of Technology. Our hiring team reviewed your application and we’d like to inform you that we are not able to advance you to the next round for the {1} position at this time.\nWe encourage you to apply again in the future, if you find an open role at our company that suits you.\n\nThank you again for applying to Harare Institute of Technology and we wish you all the best in your job search.\n\nKind Regards,\n-- Human Resources Department\n   Harare Institute of Technology \n"
